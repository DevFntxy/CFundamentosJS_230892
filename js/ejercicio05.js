...
while (j<dias.length){
    switch (j) { // Usamos 'j' para que coincida con el índice
        ...
        case 3:
            finDeSemana=false;
            mensaje="Tercer día de la chamba";
            break;
        case 4:
            finDeSemana=false;
            mensaje="Juevebeeeeeeeeees";
            break;
        case 5:
            finDeSemana=false;
            mensaje="Poooooor fin, viernes!!!!";
            break;
        case 6:
            finDeSemana=true;
            mensaje="Sabadrinkkkkkkkkkkk";
            break;
    }
...
let episodios = [
    "Episodio 1 : Ozymandias", 
    "Episodio 2: Felina",
    "Episodio 3 : Face Off",
    "Episodio 4 : Crawl Space", 
...
let seriesTrending = [
    ...
    {nombre: "Breaking Bad", temporadas: 6, totalViewers: "120M", totalReprods:"59.2M"},
    {nombre: "Un show mas", temporadas: 6, totalViewers: "15.3M", totalReprods:"2M"},
    {nombre: "Hora de aventura", temporadas: 6, totalViewers: "420.5M", totalReprods:"399.4M"},
...
let seriesTrending2 = [
    ...
    {nombre: "Breaking Bad", temporadas: 4, viewers: 40000, reproducciones: 5000000},
    {nombre: "Un show mas", temporadas: 3, viewers: 90000, reproducciones:2000000},
    {nombre: "Hora de aventura", temporadas: 6, viewers: 2000000, reproducciones:40000000},
    {nombre: "Ciberpunk", temporadas: 8, viewers: 5000000, reproducciones:10000000},
...
let seriesDeseadas = ["Bojack Horseman", "Ciberpunk", "Breaking Bad"];
